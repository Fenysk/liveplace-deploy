...
export const en = {
  ...
  // Moderation preview (FEN-2156 / FEN-2160 E3-B) — pixel preview before delete/ban.
  // count: pixel counter in the preview (AC-F2). count.one: singular form (AC-F3).
  // emptyDelete: no pixels in group to delete (AC-F6). emptyBan: ban with 0 visible
  // pixels — user will still be banned (AC-F7). unavailable: preview fetch error
  // (AC-F11). loading: non-blocking placeholder (AC-F10).
  "canvas.mod.preview.count": "{count} pixels",
  "canvas.mod.preview.count.one": "1 pixel",
  "canvas.mod.preview.emptyDelete": "No pixels to delete",
  "canvas.mod.preview.emptyBan": "This user will still be banned",
  "canvas.mod.preview.unavailable": "Preview unavailable",
  "canvas.mod.preview.loading": "Loading preview…",
