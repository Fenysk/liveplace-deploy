...
export const fr: Catalog = {
  ...
  // Aperçu de modération (FEN-2156 / FEN-2160 E3-B)
  "canvas.mod.preview.count": "{count} pixels",
  "canvas.mod.preview.count.one": "1 pixel",
  "canvas.mod.preview.emptyDelete": "Aucun pixel à supprimer",
  "canvas.mod.preview.emptyBan": "Cet utilisateur sera quand même banni",
  "canvas.mod.preview.unavailable": "Aperçu indisponible",
  "canvas.mod.preview.loading": "Chargement de l'aperçu…",
