...
export const fr: Catalog = {
  ...
  "canvas.erase": "Gommer",
  "canvas.gauge": "Jauge : {current}/{max}",
  ...
  "canvas.state.cooldown": "Jauge : 0/{max} — recharge en cours",
  ...
  "canvas.feedback.cooldown": "En attente — la jauge se recharge",
  ...
  "canvas.batchHint": "Sélectionne une case, puis Confirmer",
  ...
  "canvas.claim.celebrate": "Jauge agrandie — {max} pixels !",
  ...
  "canvas.onboarding.gaugeEmpty": "Prépare ta prochaine case pendant la recharge",
  "canvas.onboarding.pointsThreshold": "Tu as gagné de la jauge — appuie sur « Agrandir ma jauge » pour l'encaisser",
  ...
  "canvas.panel.fabTier": "Ouvrir le panneau — un palier est à encaisser",
  "canvas.panel.fabStaged": "Ouvrir le panneau — {count} pixel{count,plural,one{} other{s}} en cours",
