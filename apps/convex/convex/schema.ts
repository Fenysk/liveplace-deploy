...
export default defineSchema({
   ...
   * reads this row. (A per-canvas `bestRank` was specced for the F10 leaderboard
   * but never got a producer — removed as dead/always-null; reintroduce it with
   * its writer when F10/FEN-21 lands. See FEN-497 / audit 4b.)
   *
