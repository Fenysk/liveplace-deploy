...
export class Gateway {
  ...
  /** Outreach funnel attribution counters (FEN-242). */
  ...
  constructor(
    ...
    // ioredis exposes incr/get/sadd/smembers/scard/hsetnx directly — it satisfies
    // the narrow AttributionRedis surface.
    this.attribution = new AttributionStore(this.redis.cmd);
    this.wireUpgrade();
  }
