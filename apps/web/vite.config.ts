...
export default defineConfig({
  plugins: [
    // Route tree is generated before bundling; autoCodeSplitting delegates chunk management to the
    // router (pairs with defaultPreload:'intent'). scrollRestoration disabled (parity, R3 guard).
