...
// ---------------------------------------------------------------------------
// Star SVG (full icon) — 5-point, 18×18.
// ---------------------------------------------------------------------------
function StarIcon(): ReactElement {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M9 1l2.2 4.7 5.1.7-3.7 3.6.9 5.1L9 12.9l-4.5 2.2.9-5.1L1.7 6.4l5.1-.7z" />
    </svg>
  );
}
  ...
  return (
    ...
    >
      ...
      <div className="ui-hero-gauge__header" aria-hidden="true">
        ...
        {state === "full" && (
          <span className="ui-hero-gauge__badge">
            {t("canvas.herogauge.full" as MessageKey)}
          </span>
        )}
      </div>
