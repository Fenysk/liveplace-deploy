 ...
 * a ring + a check mark + an accessible label, so it reads in B&W / for
 * colour-blind users — never colour alone. Swatches are ≥36px touch targets.
 *
...
export function ColorSelector({
  ...
  return (
    ...
    >
      {/* Eraser at index 0 (FEN-418 A7): width auto (icon + text), same ring/check
          as colour swatches so its active state reads without colour alone. */}
      {eraser && (() => {
        ...
        return (
          ...
          >
            ...
            {selected && (
              <span className="ui-swatch__check" aria-hidden="true">
                ✓
              </span>
            )}
          </button>
