 ...
 * `BroadcastView`) with mock data and no-op handlers — no Convex, no auth — so
 * pre-merge QA can verify Arcade fidelity + a11y on the dashboard card, the
 * create form and the OBS/diffuser screen. Rendered after the foundation
...
import { BroadcastView } from "./BroadcastPage.js";
  ...
  return (
    ...
    >
      ...
      <Surface title="Diffuser — lien OBS + copie">
        <BroadcastView obsUrl="https://liveplace.tv/ma-fresque/obs" />
      </Surface>
    </main>
  );
}
