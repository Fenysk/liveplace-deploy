 ...
 * the "host wires Convex" seam, using the generated `api` from `@canvas/convex/api`.
 *
 * Flows:
...
const banBlastRadiusRef = api.moderation.banBlastRadius;
const listModeratorsRef = api.moderation.listModerators;
const listAuditLogRef = api.moderation.listAuditLog;
...
const restoreRef = api.moderation.restore;
...
export function CrisisController(props: CrisisControllerProps): React.ReactElement {
  ...
  function confirmRestore(): void {
    ...
    void restore({ canvasId: props.canvasId, modActionId: id as Id<"auditLog"> })
      .then((res) => {
