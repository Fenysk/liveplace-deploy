...
export interface PixelInfoPanelProps {
  ...
  /**
   * Render the live moderation preview between the confirm prompt and action
   * buttons (FEN-2156 E3-C / AC-F8). Absent ⇒ no preview (behaviour unchanged).
   */
            ...
            <div className="lp-pixelinfo-mod-body">
              {modArmed === null ? (
                ...
                <div className="lp-pixelinfo-mod-confirm" role="alertdialog" aria-label={t("canvas.mod.title")}>
                  ...
                  {renderModPreview && renderModPreview({ x: pixelInfo.x, y: pixelInfo.y, action: modArmed })}
