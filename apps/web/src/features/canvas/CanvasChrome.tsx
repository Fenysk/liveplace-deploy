...
import { TwitchLiveBadge } from "../gallery/TwitchLiveBadge.js";
...
export function CanvasChrome({
  ...
  // menuTriggerRef is purely intra-chrome (only used as triggerEl for focus-return
  // on BottomSheet close) — created here, not shared.
  ...
  return (
    <>
      ...
      <div className="lp-tb-left">
        ...
        {twitchLive && slug && (
          <TwitchLiveBadge twitchLogin={slug} t={t} />
        )}
