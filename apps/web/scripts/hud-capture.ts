...
const STATES: HudState[] = [
  { label: "initial (idle, charges available)", drawing: false, armed: false, count: 0, capacity: 0, charges: 10, max: 16, locked: false },
  { label: "mobile — first tap, cell armed (U1)", drawing: false, armed: true, count: 0, capacity: 10, charges: 10, max: 16, locked: false },
  { label: "mobile — armed at low zoom", drawing: false, armed: true, count: 0, capacity: 10, charges: 10, max: 16, locked: false },
  { label: "batch building (3 staged)", drawing: true, armed: false, count: 3, capacity: 10, charges: 10, max: 16, locked: false },
  { label: "draw mode, batch empty after commit (U4)", drawing: true, armed: false, count: 0, capacity: 10, charges: 10, max: 16, locked: false },
];
...
lines.push(failures.length ? `❌ ${failures.length} assertion(s) failed:` : "✅ all refinement assertions passed (U1/U4/U5/U6, FR+EN)");
